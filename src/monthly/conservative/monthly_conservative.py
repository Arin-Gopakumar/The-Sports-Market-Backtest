# sports-market-backtest/src/monthly/conservative/monthly_conservative.py
import numpy as np
...
class MonthlyConservative:
    """Conservative monthly trading strategy"""
    ...
    def calculate_price_change(self, games_data, season_avg, old_price):
        """Calculate price change for conservative monthly strategy"""

# sports-market-backtest/src/weekly/aggressive/weekly_aggressive.py
import numpy as np
...
class WeeklyAggressive:
    """Aggressive weekly trading strategy"""
    ...
    def calculate_price_change(self, games_data, season_avg, old_price):
        """Calculate price change for aggressive weekly strategy"""
    ...
    def _apply_aggressive_dampening(self, raw_delta):
        """Apply aggressive dampening formula for weekly"""
